...
class AchievementListItem(pygame.sprite.Sprite):
    def __init__(self, achievement, position, font_size=24, color=(255, 255, 255), bg_color=(0, 0, 0), border_radius=10):
        ...
        text_width = max(title_text_surface.get_width(), description_text_surface.get_width())
        text_height = title_text_surface.get_height() + description_text_surface.get_height() + 5
